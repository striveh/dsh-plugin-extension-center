...
export type RpcJson = null | boolean | number | string | readonly RpcJson[] | { readonly [key: string]: RpcJson }
...
export interface TaskApprovalRow {
  readonly state: Extract<PlanAuthorizationState, { status: 'pending' | 'approved' }>
  readonly configuration: RpcJson
}
