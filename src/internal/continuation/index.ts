/** Public composition surface for the Extension Center's internal continuation owner. */
...
export { TASK_CONTINUATION_INVALID_REASONS } from './types.ts'
export { TaskContinuationStoreCorruptionError } from './store.ts'
export type {
  ContinuationAgent,
  ContinuationAgentHandle,
  ContinuationAgentOptions,
  ContinuationAgentPresets,
  ContinuationAgents,
  ContinuationAgentSetup,
  ContinuationInbox,
  ContinuationLogger,
  ContinuationLifecycleObserver,
  ContinuationMessage,
  ContinuationResumeSetup,
  ContinuationSession,
  ContinuationSessionEvent,
  ContinuationSessionHeader,
  ContinuationSessionPersistence,
