...
export function capabilityResolverCandidate(
  candidateRef: string,
  version: string,
): CapabilityResolverCandidate | null {
  return CAPABILITY_RESOLVER_CANDIDATES.find(candidate =>
...
export function isCapabilityResolverCandidate(candidateRef: string): boolean {
