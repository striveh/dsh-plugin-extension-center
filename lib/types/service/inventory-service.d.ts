...
export declare class HostInventoryService {
    ...
    constructor(store: CenterStateStore, owners: HostOwners, catalog: () => VerifiedCatalog, inspectManagedMcp?: ((version: ManagedVersion) => Promise<McpManagedOwnerEvidence>) | null, capabilities?: () => HostCapabilityProjection);
