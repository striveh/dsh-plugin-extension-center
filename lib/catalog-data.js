...
/** Curated entries in bootstrap revision 11. Free-form upstream text is not included. */
export const BOOTSTRAP_CATALOG_ENTRIES = [
    filesystemMcpV122,
    filesystemMcpV130,
    capabilityResolverV010,
...
export const BOOTSTRAP_CATALOG_ROOT = {
...
export const BOOTSTRAP_CATALOG_ENVELOPE = {
    catalogId: 'dsh-extension-center-public',
    revision: 11,
    issuedAt: '2026-08-27T20:25:05.000Z',
    expiresAt: '2027-08-27T20:25:05.000Z',
    previousRevisionDigest: 'sha256:3ad9e4423ec7ab339a0a1ecafb1f7471c327092cb1db05eecfada5fb3e5351c0',
...
export const BOOTSTRAP_CATALOG_SIGNATURES = [{
        keyId: 'bootstrap-2026-08-26-8',
        algorithm: 'ed25519',
        value: 'iCxfmZ8WPwxkiemIdh+GS7MTiGhYJWwhyKUoDlSVhUeH6jAMyw3d0KhQVdBVz84K+JHXESq3HJXmShYMLzIrBw==',
    }];
