window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function receiptPlanEvidence(value, subject) {
			...
			if (officialDsh.schemaVersion !== 2 || officialDsh.packageName !== "@deepseek-ai/dsh" || officialDsh.packageVersion !== "0.1.1-rc.2") fail(`${subject}.recoveryExecutable.officialDsh identity`);
			for (const field of [
				"entrypointPath",
				"hostHome",
				"packageRoot",
			...
			if (pnpm.schemaVersion !== 1 || pnpm.packageName !== "pnpm" || pnpm.packageVersion !== "11.7.0" || pnpm.registryIntegrity !== "sha512-GcyFLBIMcSV2DyRD7mvgyltA+fUFmN4aCaHxd1A+AQ5Xwjx3ZG4B52HeWb+HT7IqM5jDOrlpH8E+uUa28PTWIA==") fail(`${subject}.recoveryExecutable.officialDsh.pnpm identity`);
			for (const field of [
				"packageRoot",
				"entrypointPath",
				"shimPath",
